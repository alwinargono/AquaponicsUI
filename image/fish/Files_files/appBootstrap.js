canvasWebpackJsonp([116],{"1Y62h3eT2s":function(e,t,r){"use strict"
...
var a=r("R6lUQuLu/L")(r("rzQmzckZJl"))
if(!("require"in window)){var n=r("mOY9BNujNR"),i={jquery:function(){return n},i18nObj:function(){return new Promise(function(e){e()}).then(r.bind(null,"36QOWIB4+W"))},underscore:function(){return new Promise(function(e){e()}).then(r.bind(null,"iBw8ZGM6v8"))},"jsx/course_wizard/ListItems":function(){return r.e(24).then(r.bind(null,"bzx8AghjTc"))}},o=function(e){if(e in i)return i[e]()
...
Promise.all(e.map(o)).then(function(e){t&&t.apply(void 0,(0,a.default)(e))})}}},GfsekNpohF:function(e,t,r){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
t.default=void 0
...
var a=r("R6lUQuLu/L"),n=a(r("BiqnZq/6bY")),i=a(r("VfnPWtOxDI")),o=a(r("Qwg4WMdjCp")),u=a(r("PJh52PO9+b")),l=a(r("1IKDY5pCFs"))
r("AueD11u85v");(0,u.default)().locale(ENV.MOMENT_LOCALE)
if("undefined"!=typeof ENV){ENV.TIMEZONE&&l.default.changeZone(ENV.TIMEZONE)
ENV.CONTEXT_TIMEZONE&&l.default.preload(ENV.CONTEXT_TIMEZONE)
ENV.BIGEASY_LOCALE&&l.default.changeLocale(ENV.BIGEASY_LOCALE,ENV.MOMENT_LOCALE)}if(ENV.use_high_contrast)o.default.use()
else{var d=window.CANVAS_ACTIVE_BRAND_VARIABLES||{},c={}
"test"===window.INST.environment&&(c={transitions:{duration:"0ms"}})
i.default.use({overrides:(0,n.default)({},c,d)})}if("test"===window.INST.environment){window.__CANVAS_IN_FLIGHT_XHR_REQUESTS__=0
...
//# sourceMappingURL=appBootstrap.bundle-d5160e3a24.js.116-d5160e3a24.sourcemap